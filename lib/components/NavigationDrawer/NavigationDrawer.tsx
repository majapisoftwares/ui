...
export default function NavigationDrawer({
  ...
  return (
    <>
      ...
      <div
        className={clsx(
          "fixed top-0 left-0 z-10 hidden h-full w-full max-w-xs flex-1 overflow-y-auto px-4 py-4 pt-20 lg:block",
          "bg-zinc-100/95 backdrop-blur-sm [@supports(backdrop-filter:blur(0))]:bg-zinc-100/75",
